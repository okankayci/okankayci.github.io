...
const applications = [
  {
    ...
    features: [
      ...
      "Vardiyalarınıza notlar ekleyin",
      "PDF ile rapor alın",
      "Günlük görevler ekleyin",
      "Görev yönetimini kolaylaştırmak için şablonlar oluşturun",
      "Ayrıntılı istatistikler ile takip edin",
      "Maaş, mesai ve ek ödemelerinizi takip edin ve hesaplayın",
      "Verilerinizi yedekleyin ve geri yükleyin",
      "Reklamsız tam erişim"
    ],
    status: "available",
